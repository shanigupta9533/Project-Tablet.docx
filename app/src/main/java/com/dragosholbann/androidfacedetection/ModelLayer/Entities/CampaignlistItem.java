...
public class CampaignlistItem{
	...
	@SerializedName("getVideologCount")
	private int getVideologCount;
	...
	public void setGetVideologCount(int getVideologCount){
		this.getVideologCount = getVideologCount;
	}

	public int getGetVideologCount(){
		return getVideologCount;
	}
	...
	public String toString(){
		return
				"CampaignlistddItem{" +
						...
						",budget_id = '" + budgetId + '\'' +
						",approval = '" + approval + '\'' +
						",getVideologCount = '" + getVideologCount + '\'' +
